...
const hamburger         = document.querySelector('.hamburger'),
      ...
      workHeight        = document.getElementById('work').offsetHeight,
...
window.addEventListener('scroll', function() {
    ...
    if(document.documentElement.scrollTop <= headerHeight - 70) {
    	changeActiveNav(navBtns[0]);
    } else if(document.documentElement.scrollTop <= (headerHeight + workHeight - 70)) {
    	changeActiveNav(navBtns[1]);
    } else if(document.documentElement.scrollTop <= (headerHeight + workHeight + aboutHeight - 70)) {
